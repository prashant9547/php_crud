...
if(is_post_request()){
    if(isset($_FILES["sliderimage"]) && $_FILES["sliderimage"]["error"] == 0){
       ...
       $filename = $sliderImage['imageName'];
    }
    ...
    // print_r($aboutUs);
    // exit;
    $result = sliderUpdate($sliderImage,$id);
}
?>
                            ...
                            <div class="ibox-content">
                                ...
                                <form id="aboutMore" name="aboutMore" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    <div class="form-group"><label class="col-lg-2 control-label">Slider Image</label>
                                        <div class="col-lg-5"><input title="Profile Image" type="file" name="sliderimage" id="sliderimage" placeholder="Enter Profile Image" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-5">
                                            ...
                                            <a title="Back" href="<?php echo WWW_ROOT.'/admin/slider/index.php'; ?>" class="btn btn-sm btn-info" name="sliderImage" id="sliderImage" type="button"><i class="fa fa-arrow-left" aria-hidden="true"> Back </i></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
